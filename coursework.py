...
class MyNetwork(nn.Module):
    def __init__(self):
        ...
        layers.append(nn.Conv2d(384, 384, kernel_size=2, stride=1, padding=1))
        layers.append(nn.ReLU())
        layers.append(nn.BatchNorm2d(384))
        ...
        layers.append(nn.Conv2d(256, 128, kernel_size=2, stride=1, padding=0))
        layers.append(nn.ReLU())
        layers.append(nn.BatchNorm2d(128))     

        layers.append(nn.Conv2d(128, 128, kernel_size=2, stride=1, padding=1))
        layers.append(nn.ReLU())
        layers.append(nn.BatchNorm2d(128))
        layers.append(nn.MaxPool2d(kernel_size=2, stride=2, padding=0))
